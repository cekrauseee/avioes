...
export function Placeholder({ ratio = '1 / 1', label = 'ilustração em breve', className = '', tone = 'ink' }: Props) {
  const color =
    tone === 'sage' ? 'text-sage border-sage/40'
    : tone === 'clay' ? 'text-clay border-clay/40'
