    ...
    <div className='flex h-full flex-col px-6 pt-[max(env(safe-area-inset-top),1.5rem)] pb-[max(env(safe-area-inset-bottom),2rem)]'>
        ...
        <div className='mt-12 flex flex-1 flex-col'>
          ...
          <motion.form
            ...
            onSubmit={step === 'email' ? goToPassword : step === 'name' ? handleSignUpWithName : handlePassword}
              ...
              >
                ...
                {step === 'password' && (
                  <>
                    ...
                    <button
                      type='button'
                      onClick={() => { advanceTo('email'); setError(null); setAccountExists(null); setPassword('') }}
                      className='border-line bg-paper text-ink-soft hover:bg-line/40 focus-visible:bg-line/40 focus-visible:ring-sage/40 inline-flex min-h-11 items-center gap-2 self-start rounded-full border px-4 text-sm transition-all active:scale-[0.99] focus-visible:ring-2 focus-visible:outline-none'
                    >
                ...
                {step === 'name' && (
                  <>
                    ...
                    <button
                      type='button'
                      onClick={() => { advanceTo('password'); setError(null) }}
                      className='border-line bg-paper text-ink-soft hover:bg-line/40 focus-visible:bg-line/40 focus-visible:ring-sage/40 inline-flex min-h-11 items-center gap-2 self-start rounded-full border px-4 text-sm transition-all active:scale-[0.99] focus-visible:ring-2 focus-visible:outline-none'
                    >
                      <span aria-hidden>←</span>
                      <span>voltar</span>
