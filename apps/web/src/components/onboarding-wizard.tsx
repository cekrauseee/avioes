...
export function OnboardingWizard({ initial }: { initial: OnboardingState }) {
  ...
  return (
    <div className='flex h-full flex-col px-6 pt-[max(env(safe-area-inset-top),1.5rem)] pb-[max(env(safe-area-inset-bottom),2rem)] lg:mx-auto lg:w-full lg:max-w-3xl'>
      <motion.header
