...
import { DATE_LOCALE, t, tf } from '@airplanes/i18n'
...
import { OTP_ALLOWED_ATTEMPTS, OTP_LENGTH } from '@airplanes/auth/otp-constants'
...
async function getAuthClient() {
  return (await import('@airplanes/auth/client')).authClient
}
