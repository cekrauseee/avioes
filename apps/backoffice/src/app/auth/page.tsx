  ...
  return (
    <div className='bg-bg flex min-h-dvh items-center justify-center'>
      <div className='border-line bg-paper w-full max-w-sm rounded-xl border p-8'>
        ...
        <p className='text-ink-faint mb-6 text-sm'>{t(locale, 'admin.auth.subtitle')}</p>
        {error === 'no_access' && <div className='bg-clay-soft text-clay mb-4 rounded-lg p-3 text-sm'>{t(locale, 'admin.noAccess')}</div>}
